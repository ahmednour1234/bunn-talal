<div>
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-primary-700">إنشاء طلب مبيعات</h1>
        <p class="text-sm text-gray-500 mt-1">إضافة طلب بيع جديد</p>
    </div>
    ...
    <form wire:submit="save">
        <div class="bg-card rounded-2xl shadow-sm border border-primary-100 p-6 mb-4">
            <h2 class="text-lg font-semibold text-primary-700 mb-4 pb-3 border-b border-gray-100">بيانات الطلب</h2>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                @if($payment_method === 'partial')
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">الدفعة الأولى <span class="text-red-500">*</span></label>
        ...
        {{-- Totals --}}
        <div class="bg-card rounded-2xl shadow-sm border border-primary-100 p-6 mb-4">
            <h2 class="text-lg font-semibold text-primary-700 mb-4 pb-3 border-b border-gray-100">ملخص الطلب</h2>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                @if($payment_method === 'partial')
                    <div class="bg-green-50 rounded-xl p-4 text-center">
                        <div class="text-xs text-green-600 mb-1">الدفعة الأولى</div>
        ...
        <div class="flex items-center gap-3">
            ...
            <a href="{{ route('sale-orders.index') }}" class="inline-flex items-center gap-2 px-6 py-3 bg-gray-200 text-gray-700 rounded-xl hover:bg-gray-300 transition-colors font-medium">
                إلغاء
            </a>
        </div>
    </form>
