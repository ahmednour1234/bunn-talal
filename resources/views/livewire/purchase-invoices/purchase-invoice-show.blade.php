    ...
    <div class="mb-6 flex items-center justify-between">
        ...
        <div class="flex items-center gap-2">
            @if(!in_array($invoice->status, ['cancelled', 'draft']))
                <button wire:click="recalculateStatus"
                    wire:confirm="سيتم إعادة حساب المبلغ المدفوع وحالة الفاتورة من الدفعات الفعلية والمرتجعات. هل أنت متأكد؟"
                    class="inline-flex items-center gap-2 px-4 py-2.5 bg-orange-500 text-white rounded-xl hover:bg-orange-600 transition-colors text-sm font-medium">
